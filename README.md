...
- Test features in your browser [here](https://this.geundung.dev/bxd/demo.html).
- Checkout `IE11` test [here](https://this.geundung.dev/bxd/ie.html).
...
Go to [documentation](https://this.geundung.dev/bxd)!

## 🌱 Examples

[Examples](https://this.geundung.dev/bxd/examples.html)
